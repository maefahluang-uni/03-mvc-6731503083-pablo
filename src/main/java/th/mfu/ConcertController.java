...
public class ConcertController {
    ...
    private HashMap<Integer,Concert> concertsData = new HashMap<Integer,Concert>();
    ...
    public String listConcerts(Model model) {
        ...
        model.addAttribute("concerts", concertsData.values());
    ...
    public String saveConcert(@ModelAttribute Concert concert) {
        ...
        concertsData.put(nextId, concert);
